...
local function freiya_trade_menu_creation_initiate()
    ...
    FreiyaTMod.freiya_trade_panel_frame:Resize(1100, 600)
    ...
    FreiyaTMod.freiya_trade_giving_ally_label:SetDockingPoint(5)
    FreiyaTMod.freiya_trade_giving_ally_label:SetDockOffset(-350,50)
    ...
    FreiyaTMod.freiya_trade_giving_ally_label:SetCurrentStateImageOpacity(0, 0)
    ...
    FreiyaTMod.freiya_trade_receiving_ally_label:SetDockingPoint(5)
    FreiyaTMod.freiya_trade_receiving_ally_label:SetDockOffset(350,50)
    ...
    FreiyaTMod.freiya_trade_receiving_ally_label:SetCurrentStateImageOpacity(0, 0)
    ...
    function freiya_trade_multiplayer_compat()
        ...
        FreiyaTMod.freiya_trade_faction_our_flag:SetDockingPoint(5)
        FreiyaTMod.freiya_trade_faction_our_flag:Resize(44, 44, true)
        FreiyaTMod.freiya_trade_faction_our_flag:SetDockOffset(-350,-100)
    ...
    function freiya_trade_factions_list()
        ...
        FreiyaTMod.freiya_trade_faction_their_flag:SetDockingPoint(5)
        FreiyaTMod.freiya_trade_faction_their_flag:Resize(44, 44, true)
        FreiyaTMod.freiya_trade_faction_their_flag:SetDockOffset(350,-100)
    ...
    function FreiyaTMod.freiya_trade_their_dropdown_preparation()
        ...
        FreiyaTMod.freiya_trade_their_dropdown:SetDockOffset(-350,50)
