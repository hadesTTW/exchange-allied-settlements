...
There is no diplomatic relations effect for transferring settlements between allies, although you get a diplomatic bonus for giving away your own settlements. You can not gift settlements to yourself using this system, as this is easily exploitable. If you want to do this, then you can use the [url=https://steamcommunity.com/sharedfiles/filedetails/?id=3654758530]Exchange Any Settlement Cheat Mod[/url] to do so.

Credit to the [url=https://steamcommunity.com/sharedfiles/filedetails/?id=2931377022]Trade Any Settlement mod[/url] by Freiya for the idea and base code for this mod.
