...
local function EAS_trade_menu_creation_initiate()
    ...
    function EAS_trade_factions_list()
        ...
        for i = 0, all_factions:num_items() - 1 do
            ...
            -- Filter out other human factions in multiplayer
            local is_other_human_mp = cm:is_multiplayer() and current_faction:is_human() and current_faction:name() ~= EAS_trade_current_player:name()
